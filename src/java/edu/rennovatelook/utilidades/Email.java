 ...
 */
package edu.rennovatelook.utilidades;
...
//2nd paso)compose message
        try {
            ...
            message.setFrom(new InternetAddress(user));
            message.addRecipient(Message.RecipientType.TO, new InternetAddress(para));
            message.setSubject("Recordatorio Claves Sistema Información RennovateLook");

            message.setContent(
                    "<center><img src='https://image.freepik.com/vector-gratis/mujer-confundida-olvidando-su-ilustracion-contrasena-pagina-web_108061-332.jpg' title='RennovateLook'></center>"
